...
func (r *SettingsReconciler) reconcile(ctx context.Context, settings *aifv1.Settings) (ctrl.Result, error) {
	...
	if r.Applier != nil {
		// TODO(P5-4b Task 2): pass resolved Fleet credentials here. Today
		// we pass a zero Credentials so FleetGitAuth stays empty;
		// FleetRepoURL/Branch/AuthType still propagate from spec.Fleet via
		// translateSettings.
